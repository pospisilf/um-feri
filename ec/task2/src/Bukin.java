public class Bukin extends Problem {
    ...
    public Bukin(int numberOfDimensions, int maxFes) {
        super("Bukin", 2, maxFes); // Only 2 dimensions are supported!

        if (numberOfDimensions != 2) {
            throw new IllegalArgumentException("Bukin problem only supports 2 dimensions.");
        }

        // Define the problem's specific limits
